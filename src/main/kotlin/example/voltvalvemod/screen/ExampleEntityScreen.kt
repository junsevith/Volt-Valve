...
class ExampleEntityScreen(pMenu: ExampleEntityMenu, pPlayerInventory: Inventory, pTitle: Component) :
    AbstractContainerScreen<ExampleEntityMenu?>(pMenu, pPlayerInventory, pTitle) {
    override fun init() {
        super.init()
    ...
    companion object {
        private val TEXTURE = ResourceLocation(VoltValveMod.ID, "textures/gui/gem_polishing_station_gui.png")
    }
}