...
class ElectricFurnaceEntityMenu(pContainerId: Int, inv: Inventory, entity: BlockEntity?, data: ContainerData) :
    AbstractContainerMenu(ModMenuTypes.ELECTRIC_FURNACE_MENU.get(), pContainerId) {
    val blockEntity: ElectricFurnaceEntity?
    ...
    init {
        ...
        blockEntity = (entity as ElectricFurnaceEntity?)
    ...
    override fun stillValid(pPlayer: Player): Boolean {
        return stillValid(
            ...
            pPlayer, ModBlocks.ELECTRIC_FURNACE.get()
        )
    }
